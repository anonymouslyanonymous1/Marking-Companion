...
export async function GET(req) {
    ...
    let text= ""
    if (parseInt(questionIndex)+1 === 3){
        text = "1";
    }
    else if (parseInt(questionIndex)+1 === 6){
        text = "2";
    }
    ...
    const filePath =path.join(process.cwd(), `public/Data`, "3_AO2.txt");
    ...
    const response = await ai.models.generateContent({
        ...
        \n Then using text ${text}, the student answered the question "${question}". 
        The student's answer being: "${answer}". 
        \n The following are the marking rubric: "${AO2}" \n and also "${markScheme}". 
